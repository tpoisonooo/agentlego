...
class WindowAttention(nn.Module):
    ...
    def extra_repr(self) -> str:
        repr_ = f'dim={self.dim}, window_size={self.window_size}, '  \
...
class SwinTransformerBlock(nn.Module):
    ...
    def extra_repr(self) -> str:
        repr_ = f'dim={self.dim}, input_resolution='  \
                f'{self.input_resolution}, num_heads={self.num_heads}, '  \
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        if not has_timm:
            raise RuntimeError('timm package has not been installed. '
                               'Please install with "pip install timm".')
...
def interpolate_relative_pos_embed(rel_pos_bias, dst_num_pos, param_name=''):
    # from: https://github.com/microsoft/unilm/blob/8a0a1c1f4e732
    # 6938ea7580a00d56d7f17d65612/beit/run_class_finetuning.py#L348
