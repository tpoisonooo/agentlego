...
from .cfg import get_config_path
...
from .tray_array import tra_array
...
# 127: "quarter"; 2961: "back"; 3351: "two"; 3265: "three"; 3338: "four";
# 3355: "five"; 3359: "one"
...
class Tag2Text_Caption(nn.Module):
    ...
    def __init__(
        ...
        if vit == 'swin_b':
            vision_config_path = get_config_path(f'swinB_{image_size}')
        ...
        med_config = get_config_path('med')
        ...
        q2l_config_path = get_config_path('q2l')
        q2l_config = BertConfig.from_json_file(q2l_config_path)
...
def tie_encoder_decoder_weights(encoder: nn.Module, decoder: nn.Module,
    ...
    def tie_encoder_to_decoder_recursively(
        ...
        assert isinstance(decoder_pointer, nn.Module) and isinstance(
            encoder_pointer,
            nn.Module), (f'{decoder_pointer} and {encoder_pointer} have to be '
            ...
            for name, module in decoder_modules.items():
                if name.isdigit():
                    ...
                    if not isinstance(
                        ...
                        # position in a list module list of layers
                        # in this case the decoder has added a cross-attention
                        # that the encoder does not have thus skip this step
                        # and subtract one layer pos from encoder
                        encoder_layer_pos -= 1
                        continue
                    ...
                    raise ValueError(
                        ...
                        '`tie_encoder_to_decoder` reached. '
...
def load_checkpoint_swinbase(model, url_or_filename, kwargs):
    vision_config_path = get_config_path(f'swinB_{kwargs["image_size"]}')
